...
| ETA_UPDATE                       | 1  | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
...
| CUR_ROAD_NAME_UPDATE             | 3  | phone -> dash | pointer         | string or empty                                                            | Used in setup burst with empty payload.                                                                                                          |
| NEXT_TURN_DIST_UPDATE            | 4  | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
| TBT_LIST_UPDATE                  | 5  | phone -> dash | unknown         | unknown                                                                    | Turn-by-turn list metadata. Related data service is `97`.                                                                                        |
| ACTIVE_TURN_LIST_UPDATE          | 6  | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
...
| NAVI_EVENT_TEXT_UPDATE           | 9  | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
...
| ROUTE_CALC_PROGRESS_UPDATE       | 15 | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
| BT_THROUGHPUT_TIMEOUT_UPDATE     | 16 | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
| SPEED_LIMIT_UPDATE               | 17 | phone -> dash | pointer         | observed `00 00 00 00 03 6D 70 68`                                         | Speed-limit update. Exact field layout pending.                                                                                                  |
| VIA_POINT_COUNT_UPDATE           | 18 | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
| NAVIGATION_INFO_UPDATE           | 19 | phone -> dash | unknown         | unknown                                                                    | Listed by StreetCross.                                                                                                                           |
...
| TBT_LIST_DATA_UPDATE             | 97 | phone -> dash | pointer         | unknown                                                                    | Turn-by-turn list page data.                                                                                                                     |
